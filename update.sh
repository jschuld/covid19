...
cd csv-to-influxdb
python3 csv-to-influxdb.py --create --dbname covid19 --input ../covidconverted.csv -d ';' --tagcolumns "country,province" --fieldcolumns "lat,lon,confirmed,recovered" --timecolumn date --timeformat '%m/%d/%y' --metricname confirmed 
cd ..
echo "Done"
